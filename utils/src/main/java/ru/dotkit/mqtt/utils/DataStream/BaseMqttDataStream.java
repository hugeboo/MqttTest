...
public class BaseMqttDataStream extends BaseDataStream implements IMqttDataStream {

    public static final int MAX_LENGTH_LIMIT = 268435455;

    public BaseMqttDataStream(InputStream inputStream, OutputStream outputStream) throws IOException {
